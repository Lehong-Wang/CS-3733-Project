...
public class AudioVisualEmbedded implements TableController<AudioVisual, Integer> {
    /** name of table */
    ...
    public AudioVisualEmbedded(String tbName, String[] cols, String pkCols, ArrayList<AudioVisual> objList)
            throws SQLException {
    ...
    public boolean addEntry(AudioVisual obj) {
        ...
        try {
            ...
            s.setString(2, av.getDeviceType());
            s.setString(3, av.getLocID());
            s.setString(4, av.getDescription());
            s.executeUpdate();
            return true;
    ...
    public ArrayList<AudioVisual> readBackup(String fileName) {
        ArrayList<AudioVisual> avList = new ArrayList<>(); // **
