...
public class FoodRequestTbl implements TableController<FoodRequest, ArrayList<Integer>> {
  ...
  private static edu.wpi.GoldenGandaberundas.tableControllers.FoodService.FoodRequestTbl instance = null;
  ...
  public static edu.wpi.GoldenGandaberundas.tableControllers.FoodService.FoodRequestTbl getInstance() {
    if (instance == null) {
      synchronized (TableController.class) {
        if (instance == null) {
          try {
            instance = new edu.wpi.GoldenGandaberundas.tableControllers.FoodService.FoodRequestTbl();
  ...
  @Override
  public ArrayList<FoodRequest> readTable() {return this.getCurrentTable().readTable();}

  @Override
  public boolean addEntry(FoodRequest obj) {return this.getCurrentTable().addEntry(obj);}

  @Override
  public ArrayList<FoodRequest> readBackup(String fileName) {return this.getCurrentTable().readBackup(fileName);}

  @Override
  public void createTable() {this.getCurrentTable().createTable();}

  @Override
  public FoodRequest getEntry(ArrayList<Integer> pkID) {return this.getCurrentTable().getEntry(pkID);}
  ...
  public ArrayList<FoodRequest> loadBackup(String fileName) {return this.getCurrentTable().loadBackup(fileName);}
