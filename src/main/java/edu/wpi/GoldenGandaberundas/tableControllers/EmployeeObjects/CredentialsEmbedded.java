...
public class CredentialsEmbedded implements TableController<Credential, Integer> {
    /** name of table */
    ...
    public CredentialsEmbedded(String tbName, String[] cols, String pkCols, ArrayList<Credential> objList)
            throws SQLException {
