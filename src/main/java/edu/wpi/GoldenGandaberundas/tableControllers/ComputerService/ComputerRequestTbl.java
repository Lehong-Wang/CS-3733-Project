...
import edu.wpi.GoldenGandaberundas.tableControllers.ComputerService.ComputerRequestClientServer;
import edu.wpi.GoldenGandaberundas.tableControllers.ComputerService.ComputerRequestEmbedded;
...
public class ComputerRequestTbl implements TableController<ComputerRequest, ArrayList<Integer>> {
  ...
  @Override
  public ArrayList<ComputerRequest> readTable() {return this.getCurrentTable().readTable();}

  @Override
  public boolean addEntry(ComputerRequest obj) {return this.getCurrentTable().addEntry(obj);}

  @Override
  public ArrayList<ComputerRequest> readBackup(String fileName) {return this.getCurrentTable().readBackup(fileName);}

  @Override
  public void createTable() {this.getCurrentTable().createTable();}

  @Override
  public ComputerRequest getEntry(ArrayList<Integer> pkID) {return this.getCurrentTable().getEntry(pkID);}
  ...
  public ArrayList<ComputerRequest> loadBackup(String fileName) {return this.getCurrentTable().loadBackup(fileName);}
