...
public class RequestEmbedded implements TableController<Request, Integer> {
  /** name of table */
   ...
   * @throws SQLException
   */
  public RequestEmbedded(String tbName, String[] cols, String pkCols, ArrayList<Request> objList)
      throws SQLException {
    this.tbName = tbName;
    colNames = Arrays.asList(cols);
    this.pkCols = pkCols;
    createTable();
    this.objList = new ArrayList<Request>();
