...
public class AudioVisualProviderController {
  ...
  @FXML private Label avIDLabel;

  @FXML private TableView avTable;
  @FXML private TableColumn<AudioVisualRequest, Integer> reqID;
  @FXML private TableColumn<AudioVisualRequest, String> locID;
  @FXML private TableColumn<AudioVisualRequest, Integer> tStartCol;
  @FXML private TableColumn<AudioVisualRequest, Integer> tEndCol;
  @FXML TableColumn<AudioVisualRequest, Integer> patientID;
  @FXML TableColumn<AudioVisualRequest, String> requestStatus;
  ...
  private TableController tableController = AudioVisualRequestTbl.getInstance();
  ...
  public void initialize() {
    ...
    reqID.setCellValueFactory(new PropertyValueFactory<AudioVisualRequest, Integer>("requestID"));
    locID.setCellValueFactory(new PropertyValueFactory<AudioVisualRequest, String>("locationID"));
    tStartCol.setCellValueFactory(
        new PropertyValueFactory<AudioVisualRequest, Integer>("timeStart"));
    tEndCol.setCellValueFactory(new PropertyValueFactory<AudioVisualRequest, Integer>("timeEnd"));
    ...
    pathButton.setOnMouseReleased(
        (event) -> {
          AudioVisualRequest selectedItem =
              (AudioVisualRequest) avTable.getSelectionModel().getSelectedItem();
          try {
  ...
  public void updateStatus() {
    try {
      Request selectedItem = (Request) avTable.getSelectionModel().getSelectedItem();
  ...
  public void getRequestInfo() {
    if (avTable.getSelectionModel().getSelectedItem() != null) {
      AudioVisualRequest selectedItem =
          (AudioVisualRequest) avTable.getSelectionModel().getSelectedItem();
      try {
  ...
  @FXML
  public void refresh() {
    tableController = AudioVisualRequestTbl.getInstance();
    avTable.getItems().setAll(tableController.readTable());
  }
