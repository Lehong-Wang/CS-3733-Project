...
public class MapController {
    ...
    @FXML
    JFXButton homeBtn; // home btn with icon and text
    @FXML
    ...
    @FXML
    private GesturePane towerPane = new GesturePane();

    @FXML
    private Pane nodeDataPane;
    @FXML
    private Pane sideViewPane;
    ...
    @FXML
    private Label cleanLabel = new Label();
    @FXML
    private Label dirtyLabel = new Label();
    @FXML
    private Label bedLabel = new Label();
    @FXML
    private Label reclinerLabel = new Label();
    @FXML
    private Label pumpsLabel = new Label();
    @FXML
    private Label xrayLabel = new Label();
    @FXML
    private Label cleanBedLabel = new Label();
    @FXML
    private Label dirtyBedLabel = new Label();
    @FXML
    private Label cleanReclinerLabel = new Label();
    @FXML
    private Label dirtyReclinerLabel = new Label();
    @FXML
    private Label cleanPumpsLabel = new Label();
    @FXML
    private Label dirtyPumpsLabel = new Label();
    @FXML
    private Label xrayLabel2 = new Label();
    @FXML
    private Label floorLabel = new Label();
    ...
    public void dividePath(List<String> locs){
        for (int i = 0; i < locs.size() - 1; i++) {
            if (locs.get(i).substring(locs.size() - 3, locs.size() - 1).equals("L2")) {
                coord.get(0).add(locs.get(i));
            } else if (locs.get(i).substring(locs.size() - 3, locs.size() - 1).equals("L1")) {
                coord.get(1).add(locs.get(i));
            } else if (locs.get(i).substring(locs.size() - 2, locs.size() - 1).equals("1")) {
                coord.get(2).add(locs.get(i));
            } else if (locs.get(i).substring(locs.size() - 2, locs.size() - 1).equals("2")) {
    ...
    public void animatedPath() {
        ...
        //TODO The poly line needs to update between floors and draw the correct line
