...
public class RequestValidator {
  ...
  // normal
  public RequestValidator(String notes) {
    this.notes = notes;
    this.dosage = "0";
    this.quantity = "0";
  }
  ...
  // medicine
  public RequestValidator(String notes, String dosage, String quantity) {
    this.notes = notes;
    this.dosage = dosage;
  ...
  // gift
  public RequestValidator(String notes, String dosage) {
    this.notes = notes;
    this.dosage = dosage;
    this.quantity = "0";
  }
  ...
  private boolean validateNotes() {
    ...
    return !this.notes
        ...
        .matches(
            "\\b(ALTER|CREATE|DELETE|DROP|DROP TABLE|EXEC(UTE){0,1}|INSERT( +INTO){0,1}|MERGE|SELECT|UPDATE|UNION( +ALL){0,1})\\b");
  }
  String[] sqlComs = {"ALTER", "CREATE", "DELETE", "DROP", "DROP TABLE", "EXEC", "EXECUTE", "INSERT", "INSERT INTO", "INTO", "MERGE", "SELECT", "UPDATE", "UNION", "UNION ALL", "ALL"};
  ...
  public String traceValidationError() {
    ...
    if (!validateNotes()) {
      ...
      errorMsg = "Field 'Quantity' is Invalid";
    } else if (!validateDosage()) {
      errorMsg = "Field 'Dosage' is Invalid";
    } else {
