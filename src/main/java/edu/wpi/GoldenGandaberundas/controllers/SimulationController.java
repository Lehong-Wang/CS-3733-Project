...
public class SimulationController {
  ...
  public void initialize() {
    ...
    coord.add(new ArrayList<ArrayList<String>>());
    coord.add(new ArrayList<ArrayList<String>>());
    int medStuff = SimMedEquipmentTbl.getInstance().readTable().size();
    ...
    ImageView settings = new ImageView(floorMaps.equalizer);
  ...
  public void animatedPath() {
    ...
    String color;
    if (SimMedEquipmentTbl.getInstance()
        .getEntry(medEquip + 1)
        .getMedEquipmentType()
        .equals("Bed")) {
      color = "#FF0000";
    } else if (SimMedEquipmentTbl.getInstance()
        .getEntry(medEquip + 1)
        .getMedEquipmentType()
        .equals("Recliner")) {
      color = "#800080";
  ...
  public void animateFloor() {
    animatedPathNodeGroup.getChildren().clear();
    for (int i = 0; i < SimMedEquipmentTbl.getInstance().readTable().size(); i++) {
      medEquip = i;
      animatedPath();
    }
  }
