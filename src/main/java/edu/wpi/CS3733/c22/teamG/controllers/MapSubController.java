...
import edu.wpi.CS3733.c22.teamG.controllers.validators.AddLocationValidator;
    ...
    if (validator.validateTextFields()) {
      if (edit) {
        ...
        locationTbl.editEntry(
            selectedID, "floor", mapController.getCurrentFloor().trim().toLowerCase(Locale.ROOT));
        locationTbl.editEntry(
