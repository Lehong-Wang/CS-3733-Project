...
public class FoodRequestTbl implements TableController<FoodRequest, ArrayList<Integer>> {
  ...
  private static edu.wpi.CS3733.c22.teamG.tableControllers.FoodService.FoodRequestTbl instance =
      null;
  ...
  public static edu.wpi.CS3733.c22.teamG.tableControllers.FoodService.FoodRequestTbl getInstance() {
    if (instance == null) {
      synchronized (TableController.class) {
        if (instance == null) {
          try {
            instance = new edu.wpi.CS3733.c22.teamG.tableControllers.FoodService.FoodRequestTbl();
